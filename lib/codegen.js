...
var getSchemaDefinition = function(schema) {
    ...
    obj.properties = _.map(schema.properties, function(param, key){
        return {
            name: key,
            type: param.type,
    ...
    _.forEach(swagger.paths, function(api, path){
        ...
        _.forEach(api, function(op, m){
            ...
            var method = {
                path: path,
                className: opts.className,
                methodName: op['x-swagger-js-method-name'] ? op['x-swagger-js-method-name'] : (op.operationId ? normalizeName(op.operationId) : getPathToMethodName(opts, m, path)),
